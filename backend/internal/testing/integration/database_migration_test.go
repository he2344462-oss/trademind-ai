...
func TestAutoMigrateAgainstIsolatedPostgres(t *testing.T) {
	...
	for _, table := range []string{"admin_users", "products", "product_skus", "source_products", "candidates", "candidate_analyses", "listing_drafts", "product_publish_tasks", "inventory_sync_tasks"} {
